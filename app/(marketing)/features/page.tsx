...
const sections = [
  {
    ...
    description: "The Queno agent passively observes every inbound request and automatically builds a live inventory of all API endpoints, authentication methods, and data sensitivity indicators.",
    features: [
  ...
  },
  {
    ...
    description: "Unlike cloud-based solutions, Queno redacts sensitive data inside your application process. If redaction fails for any reason, the event is dropped entirely - never transmitted with raw data.",
    features: [
